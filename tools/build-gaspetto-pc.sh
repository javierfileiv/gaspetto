...
configure_and_build "box-release" "build-box" "gbox"
configure_and_build "box-debug" "build-box-debug" "gbox"
...
smoke_run "Gaspetto Box (Release)" "$EMU_PC_DIR/build-box/targets/gbox/gbox"
smoke_run "Gaspetto Box (Debug)" "$EMU_PC_DIR/build-box-debug/targets/gbox/gbox"
