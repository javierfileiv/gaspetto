...
//     const struct device *dev = device_get_binding("spi1");
//     uint32_t dtr = 0;
...
// #define WIFI_COEX_IN_DEV (void *)&wifi_coex_in_spec
// #define CONFIG_WLAN_UWB_GPIO_PIN 0
// #define CONFIG_WLAN_UWB_GPIO_PORT 0


// static struct nrf24L01_device nrf24 = {
// 	.dev = EXT_SW_DEV,
// 	.port = CONFIG_UWB_EXT_SW_GPIO_PORT,
