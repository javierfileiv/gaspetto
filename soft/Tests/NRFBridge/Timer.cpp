...
int8_t Timer::oscillate(uint8_t pin, unsigned long period,
...
/**
 * This method will generate a pulse of !startingValue, occuring period after
 * the call of this method and lasting for period. The Pin will be left in
 * !startingValue.
 */
...
/**
 * This method will generate a pulse of startingValue, starting immediately and
 * of length period. The pin will be left in the !startingValue state
 */
int8_t Timer::pulseImmediate(uint8_t pin, unsigned long period,
                             uint8_t pulseValue) {
