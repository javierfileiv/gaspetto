...
TIM_TypeDef *Timer2 = (TIM_TypeDef *)pinmap_peripheral(digitalPinToPinName(pin_M1_FWD), PinMap_PWM);
HardwareTimer *m1_timer = new HardwareTimer(Timer2);

TIM_TypeDef *Timer3 = (TIM_TypeDef *)pinmap_peripheral(digitalPinToPinName(pin_M2_FWD), PinMap_PWM);
