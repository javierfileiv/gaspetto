...
BuzzerT::BuzzerT(uint8_t buzzer_pin) {
  ...
  TIM_TypeDef *TimerSTM = (TIM_TypeDef *)pinmap_peripheral(
      digitalPinToPinName(buzzer_pin), PinMap_PWM);
  this->channel = STM_PIN_CHANNEL(
      pinmap_function(digitalPinToPinName(buzzer_pin), PinMap_PWM));
