...
//     const uint32_t distance = DISTANCE_CM_FWD_BWD;
...
// {
//     uint32_t target_pulses_left = 0, target_pulses_right = 0;
//     uint32_t diff = 0;
//     const uint32_t distance_left = DISTANCE_CM_FWD_BWD, distance_right = DISTANCE_CM_TURN_RIGHT;
...
//     uint32_t target_pulses_left = 0, target_pulses_right = 0;
//     uint32_t diff = 0;
//     const uint32_t distance_left = DISTANCE_CM_TURN_LEFT, distance_right = DISTANCE_CM_FWD_BWD;
