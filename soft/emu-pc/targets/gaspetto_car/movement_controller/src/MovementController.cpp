...
void MovementController::setMotor(bool forward_motor_left, uint32_t motor_left_speed_percent,
                                  uint32_t distance_cm_left, bool forward_motor_right_percent,
                                  uint32_t motor_right_speed, uint32_t distance_cm_right)
{
    ...
    _motorControl.setMotorSpeeds(motor_left_speed_percent, motor_right_speed, forward_motor_left,
                                 forward_motor_right_percent);
}
